...
<head>
    ...
    <script src="js/popper.min.js"></script>                                          //installing multiple java script files for styling
...
<body>                                                                           //using bootstrap to align the contents
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h3 class="py-5 text-center"> Bug Tracker System</h3>
